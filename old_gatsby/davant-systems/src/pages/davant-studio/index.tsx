		...
		<>
			...
			<main className="">
				<section className="border-b-2 hero__wrapper border-slate-400 border-opacity-5">
					<div className="relative flex flex-col items-center justify-center min-h-screen pt-12 overflow-hidden hero sm:flex-row">
							...
							<div className="flex flex-col items-center mb-2">
								...
								<div className="relative flex flex-col items-center cta-wrapper">
									<div className="flex flex-col software-spotlight sm:flex-row">
										<div className="flex flex-col pt-4 mx-auto text-left sm:pt-1 md:pt-24 sm:ml-auto text">
											<h1 className="mb-4 font-light text-transparent bg-gradient-to-tr from-pink-400 via-fuchsia-500 to-purple-800 bg-clip-text">
												<span className="-mb-4 text-5xl font-bold sm:text-4xl md:text-6xl lg:text-6xl">Davant </span><span className="text-5xl leading-tight sm:text-4xl md:text-6xl lg:text-6xl">Studio</span>
											</h1>

											<p className="mb-12 text-transparent font-extralight bg-gradient-to-tr from-pink-400 via-fuchsia-500 to-purple-800 bg-clip-text">
											...
											<div className="flex flex-col px-0 py-8 bg-opacity-0 shadow-xl sm:px-0 md:px-0 bg-base-300">
												<div className="relative flex flex-col gap-4 ml-0 md:flex-row">
													<div className="text-sm">
														<Link className="relative z-10 w-auto pl-0 pr-4 mt-4 mb-1 text-sm border-opacity-50 rounded-sm shadow-sm cta__button--download effect__chromeflash btn btn-primary indicator bg-gradient-to-br from-pink-400 via-fuchsia-500 to-purple-500 hover:from-pink-500 hover:to-purple-400 hover:scale-105 text-neutral border-1 border-cyan-500 shadow-pink-500"
															to="https://mailchi.mp/davantsystems/davant-studio-free-download">
															<span className="p-2 bg-transparent rounded-full badge-neutral">
																<svg className="stroke-neutral" width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
																	...
																	<g id="SVGRepo_iconCarrier">
																		...
																		<path d="M12 2L12 15M12 15L9 11.5M12 15L15 11.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> </g>
																</svg>
															</span>
															<span className="pt-1">Download Free Version</span>
														</Link>
														<div className="pt-1">
													...
													<div className="">
														<Link className="relative w-auto mt-4 mb-2 text-sm border-opacity-50 rounded-md shadow-sm btn-outline cta__button--download effect__chromeflash btn btn-primary md:text-sm indicator hover:scale-105 text-neutral border-1 btn-secondary"
															to="#signup">
															{/* <span className="p-2 bg-transparent rounded-full badge-neutral">
															<svg className="stroke-neutral" width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
																<g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
															...
															<span className="pt-1">View Premium Features</span>
														</Link>
														<div className="">
															<p className="pt-1 mb-4 text-xs text-center">$30/month, cancel anytime</p>
														</div>
													</div>
												</div>
												<div className="flex mx-auto mt-8 text-xs">
													{/* <div className="flex">
														<p className="m-auto mr-4 align-center">Available for</p>
													</div> */}
													<div className="flex items-center mr-4 align-center">
														<svg height="22px" width="24px" className="item-start stroke-white fill-white" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452.986 452.986" fill="#ffffff"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M165.265,53.107L21.689,81.753v132.531l143.575-2.416V53.107 M431.297,245.583l-233.18-3.991 v164.822l233.18,46.571V245.583 M165.265,241.097l-143.575-2.438v132.509l143.575,28.668V241.097 M431.297,0l-233.18,46.528 v164.822l233.18-3.969V0"></path> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> </g> </g></svg>
														<p className="mt-auto mb-auto ml-1 align-center">Windows</p>
													</div>
													<div className="flex items-center mr-4 align-center">
														<svg width="22px" height="22px" className="item-start stroke-white fill-white" viewBox="-1.5 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#fff">
														...
														<p className="ml-1">Mac</p>
													</div>

												</div>
											</div>
										</div>
										<div className="relative mb-0 ml-0 space-x-2 bg-opacity-0 border-0 border-opacity-50 border-indigo-950 screenshot-carousel wrapper__screenshots sm:w-60 md:w-1/2">
											<div className="relative shadow-md item">
												<StaticImage
					...
					to-transparent opacity-20 animate-spin-slow z-0 mix-blend-hard-light"></div> */}
							...
							<div className="relative flex flex-col justify-center gap-4 content md:flex-row">
