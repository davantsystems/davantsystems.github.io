                    ...
                    <ul className="list-disc pl-5">
                        ...
                        <li><strong>Graphics Card</strong> (critical for performance):
                            <ul className="list-disc pl-5">
                                ...
                                <li><strong>AMD</strong>: Compatible, high-end GPUs required for optimal performance. See <a className="link link-secondary" href={contentVariables.auto1111.links.installation.windows.amd}>AMD Specific Instructions<ExternalLink/></a> in Automatic 1111 Repository.</li>
                            </ul>
                        </li>
                        <li><strong>RAM</strong>:
                            <ul className="list-disc pl-5">
                        ...
                        <li><strong>Additional Requirements</strong>:
                            <ul className="list-disc pl-5">
                                ...
                                <li>For detailed specifications and updates, refer to the <a className="link link-secondary" href={contentVariables.auto1111.links.repoUrl}>Automatic 1111 Repository<ExternalLink/></a>.</li>
                            </ul>
                        </li>
                    </ul>
                </div>
