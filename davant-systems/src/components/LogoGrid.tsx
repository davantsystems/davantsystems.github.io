    ...
    return (
        <>
            ...
            <div className="relative flex items-center justify-center px-2 py-4 sm:px-4 md:px-8 sm:py-2">
                ...
                <div className="relative flex items-center justify-center px-2 py-4 sm:px-4 md:px-8 sm:py-2">
                    <StaticImage
                        src="../images/logos/logo-TechWeekLA-white.png"
                        quality={80}
                        placeholder="blurred"
                        loading="lazy"
                        alt="XRM logo"
                ...
                <div className="relative flex items-center justify-center px-2 py-2 sm:px-4 md:px-8 sm:py-0">
                    <StaticImage
                        src="../images/logos/logo-BruinAI-white.png"
                        quality={80}
                        placeholder="blurred"
                        loading="lazy"
                        alt="BruinAI logo"
                ...
                <div className="relative flex items-center justify-center py-2 sm:py-0">
                    <StaticImage
                        src="../images/logos/logo-PugetSystems-white.png"
                        quality={80}
                        placeholder="blurred"
                        loading="lazy"
                        alt="XRM logo"
                ...
                <div className="relative flex items-center justify-center px-2 py-2 sm:px-4 md:px-8 sm:py-0">
                    <StaticImage
                        src="../images/logos/logo-Nuleep-white.png"
                        quality={80}
                        placeholder="blurred"
                        loading="lazy"
                        alt="XRM logo"
                ...
                <div className="relative flex items-center justify-center px-2 py-2 sm:py-0">
                    <StaticImage
                        src="../images/logos/logo-FbrcAI-white.png"
                        quality={80}
                        placeholder="blurred"
                        loading="lazy"
                        alt="XRM logo"
                ...
                <div className="relative flex items-center justify-center px-2 py-2 sm:px-4 md:px-8 sm:py-0">
                    <StaticImage
                        src="../images/logos/logo-ImmerseStudio-white.png"
                        quality={80}
                        placeholder="blurred"
                        loading="lazy"
                        alt="XRM logo"
