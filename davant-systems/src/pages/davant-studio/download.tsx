				...
				<section className="relative border-b-2 hero__wrapper border-slate-400 border-opacity-5">
					<div className="relative pt-20">
						...
						<div className="relative z-20 pt-8 pb-16">
							...
							<h1 className="mb-4 font-light text-center text-transparent bg-gradient-to-tr from-pink-400 via-fuchsia-500 to-purple-800 bg-clip-text">
								<span className="block text-xl font-bold sm:text-2xl md:text-3xl lg:text-4xl">Downloads</span>
							</h1>
							<div className="box-border flex flex-col w-full max-w-2xl gap-2 px-4 mx-auto md:flex-row md:box-content">
								<div className="flex flex-col items-center flex-1 p-4 border-2 rounded-md bg-base-300 border-primary border-opacity-15">
									...
									<div className="text-xs text-center md:text-left">
										<p className="mb-2">Our creative software application.</p>
										<p>An interface to control Stable Diffusion and integrate it into your workflow.</p>
									</div>
								</div>
								<div className="flex flex-col items-center flex-1 p-4 bg-opacity-100 border-2 rounded-md border-opacity-5 border-secondary bg-base-300">
									<Link
										className="w-full pl-0 mb-4 border-purple-900 shadow-md text-md lg:text-md hover:shadow-lg hover:border-cyan-300 hover:bg-cyan-500 hover:border-purple-900 btn btn-md btn-secondary shadow-base-300"
