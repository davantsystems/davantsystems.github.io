									...
									<div className="flex flex-col software-spotlight sm:flex-row">
										<div className="flex flex-col pr-8 text-left text">
											<h1 className="mb-0 font-light text-transparent bg-gradient-to-tr from-pink-400 via-fuchsia-500 to-purple-800 bg-clip-text">
												<span className="block -mb-4 text-5xl font-bold sm:text-7xl md:text-8xl">Resources </span><span className="block text-5xl leading-tight sm:text-7xl md:text-8xl">Studio</span>
											</h1>
...
export const Head: HeadFC = () => <title>Davant Systems | AI & StableDiffusion Resources</title>
