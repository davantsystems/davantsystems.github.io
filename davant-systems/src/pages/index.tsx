							...
							<div className="
								...
								<div className="flex flex-col-reverse justify-center md:flex-row items-center md:gap-10">
									...
									">
											...
											<span className="block text-5xl font-bold leading-10 mb-3">Mind-blowing </span>
											<span className="block font-light leading-3 pl-0.5 pb-8 -mb-4 overflow-visible">possibilities</span></p>

										<div className="join join-vertical px-8 pt-10 pb-4 md:mt-auto z-10 mb-auto mx-auto bg-base-300 bg-opacity-80 shadow-md">
											<div className="">
